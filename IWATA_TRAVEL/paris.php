...
<!-- Page Content -->
    ...
    <div class="content">
      <!-- sidebar-->
      <div class="sidebar" style="min-height: 920px;">
        <div class="row">
          <div class="col-md-1">
      ...
      <!-- main -->
      <div class="main" style="min-height: 920px;">        
        <div class="mainhome">
          <p style="font-family: times new roman; font-size: 16px;">Home > Tour > Paris</p>
         


        <hr>
        <p style="text-align: center; font-family: ravie; font-size:  120%">Paris Tour !!</p>
        <hr>

        <center>
           	<img src="img/PARIS.jpg" width="500px" height="200px" style="border-radius: 5px;">
           	 <br>
          <p style="background-color: violet; width: 500px; margin: 5px; border-radius: 5px; ">Menawarkan Paket Tour Ke Tempat Wisata Terkenal Yang Berada Di Negara Perancis !!</p><br>
        </center>
        ...
        <form class="bg-lightdark" action="proses_simpan.php" method="post" name="pesawat" id="tiket" style="margin:5px; auto 0;padding:0;width:auto; border-radius: 5px; background-color: lightgray;">
			<table width="600" border="0" align="center" cellpadding="0" cellspacing="10">
				<div class="f-center" style="text-align: center;"><h1>Penginputan Data Tour</h1></div>
				<hr>
				<!--<tr>
