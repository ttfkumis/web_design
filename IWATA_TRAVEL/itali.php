...
<!-- Page Content -->
    ...
    <div class="content">
      <!-- sidebar-->
      <div class="sidebar" style="min-height: 950px;">
        <div class="row">
          <div class="col-md-1">
      ...
      <div class="main" style="min-height: 950px;">        
        <div class="mainhome">
          <p style="font-family: times new roman; font-size: 16px;">Home > Package > Tour</p>
         


        <hr>
        <p style="text-align: center; font-family: ravie; font-size:  120%">Paket ITALY!!</p>
        <hr>

        <center>
           	<img src="img/ITALY.jpg" width="500px" height="200px" style="border-radius: 5px;">
           	 <br>
          <p style="background-color: violet; width: 500px; margin: 5px; border-radius: 5px; ">Menawarkan Paket Tour Ke Tempat Wisata Terkenal Yang Berada Di Negara ITALY <b>Untuk 5 Orang Dengan Harga Rp 1.000.000,- Per Orang</b> !!</p><br>
        </center>
        ...
        <form class="bg-lightdark" action="proses_simpan.php" method="post" name="pesawat" id="tiket" style="margin:5px; auto 0;padding:0;width:auto; border-radius: 5px; background-color: lightgray;">
			<table width="600" border="0" align="center" cellpadding="0" cellspacing="10">
				<div class="f-center" style="text-align: center;"><h1>Penginputan Data Package</h1></div>
				<hr>
				<!--<tr>
