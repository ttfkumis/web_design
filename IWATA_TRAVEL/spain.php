...
<!-- Page Content -->
    ...
    <div class="content">
      ...
      <div class="main" style="min-height: 920px;">        
        <div class="mainhome">
          <p style="font-family: times new roman; font-size: 16px;">Home > Tour > Spain</p>
         


        <hr>
        <p style="text-align: center; font-family: ravie; font-size:  120%">Spain Tour !!</p>
        <hr>

        <center>
           	<img src="img/SPAIN.jpg" width="500px" height="200px" style="border-radius: 5px;">
           	 <br>
          <p style="background-color: violet; width: 500px; margin: 5px; border-radius: 5px; ">Menawarkan Paket Tour Ke Tempat Wisata Terkenal Yang Berada Di Negara Spanyol !!</p><br>
        </center>
