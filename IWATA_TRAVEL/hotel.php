...
<!-- Page Content -->
    ...
    <div class="content">
      ...
      <div class="main" style="min-height: 790px;">        
        <div class="mainhome">
          <p style="font-family: times new roman; font-size: 16px;">Home > Hotel</p>
         


        <hr>
        <p style="text-align: center; font-family: ravie; font-size:  120%">Hotel !!</p>
        <hr>

        <center>
           	<img src="img/hotel1.jpg" width="200px" height="112px" style="border-radius: 5px;">
        	<img src="img/hotel2.jpg" width="200px" style="border-radius: 5px;">
        </center>
        ...
        <form class="bg-lightdark" action="proses_simpan.php" method="post" name="pesawat" id="tiket" style="margin:5px; auto 0;padding:0;width:auto; border-radius: 5px; background-color: lightgray;">
			<table width="600" border="0" align="center" cellpadding="0" cellspacing="10">
				<div class="f-center" style="text-align: center;"><h1>Penginputan Data Hotel</h1></div>
				<hr>
				<!--<tr>
