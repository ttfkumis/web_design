...
<!-- Page Content -->
    ...
    <div class="content">
      ...
      <div class="main" style="min-height: 790px;">        
        <div class="mainhome">
          <p style="font-family: times new roman; font-size: 16px;">Home > Package</p>
         


        <hr>
        <p style="text-align: center; font-family: ravie; font-size:  120%">Package !!</p>
        <hr>
        <br>
        <center>
          <h5>PAKET ITALI (PROMO) !!</h5>
        	<img src="img/ITALY.jpg" width="500px" height="200px" style="border-radius: 5px;">
          <br>
          <p style="background-color: violet; width: 500px; margin: 5px; border-radius: 5px; "><a href="itali.php"> Click here for detail !!</a></p><br>
        </center>
